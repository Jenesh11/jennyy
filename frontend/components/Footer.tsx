            ...
            <div className="container">
                <div className={styles.footerContent}>
                    ...
                    <div className={styles.footerSection}>
                        <h3 className={styles.footerLogo}>Jennyy</h3>
                        <p className={styles.footerText}>
                            Premium clothing for the modern individual. Crafted with care, designed for life.
                        </p>
                    ...
                    <div className={styles.footerSection}>
                        ...
                        <ul className={styles.footerLinks}>
                            ...
                            <li><Link href="/products?category=bestsellers">Best Sellers</Link></li>
                        </ul>
                    </div>
                ...
                <div className={styles.footerBottom}>
                    <p className={styles.copyright}>
                        © {new Date().getFullYear()} Jennyy. All rights reserved.
                    </p>
